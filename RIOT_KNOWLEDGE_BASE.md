# Riot Labs — Knowledge Base

## Company Overview

**Riot Labs** is a British vape company that manufactures in the UK. Founded to help people quit smoking, Riot has grown into one of the UK's leading independent vape brands. The company tagline is **"Live Loud. Do Better."**

Riot's product portfolio includes:
- **Riot Bar Edtn** — core e-liquid range
- **RIOT CONNEX** — closed-pod system designed for the convenience retail channel (pre-filled pods, 10 flavours, 500mAh battery, fully TRPR compliant, RRP £5.99 device / £3.99 for 2-pack pods)
- **KURO** — premium 10ml e-liquid brand, the first born from Fantasia Flavour House. Tokyo-inspired creative, matte black/neon aesthetic
- **E-liquids** manufactured through **Fantasia Flavour House**, Riot's in-house flavour development and production operation

Riot also operates:
- **Riot Activist** — campaigning arm that fights misinformation, disproportionate regulation and policies that harm adult smokers' right to switch
- **Riot Rehab** — smoking cessation initiative
- **Riot Magazine** — internal/external content publication
- **Retailer WhatsApp Channel** — direct trade comms channel for retailers
...
### Ben Johnson — CEO
- Founder and CEO of Riot Labs
- Built Riot from the ground up into one of the UK's leading independent vape brands
- Passionate about British manufacturing, helping people quit smoking and building a category that earns public trust
- Known for backing bold campaigns — from sponsoring non-league football club Wroxham FC to launching Riot Activist
- **Tone:** Direct, plain-speaking, visionary. Talks like a founder who's built something real — not a corporate suit
- **Topics:** Company strategy, British manufacturing, industry leadership, regulatory engagement, harm reduction, brand campaigns

### David Donaghy — Head of Brand & Marketing
- Leads Riot's brand strategy, creative output, PR and marketing
- Architect of Riot's comms approach across trade, consumer and regulatory channels
- Drives the Riot Activist campaigning arm and oversees the creative marketing team
...
- **Topics:** Brand strategy, trade/retailer comms, Riot Activist, product launches, vape tax comms, industry marketing and PR

### Other Key People (referenced in internal docs)
- **Mark Tarrant** — involved in comms planning and vape tax strategy
- **Matthew Crann** — involved in comms planning
- **Lewis Davey** — involved in PR and content strategy
...
|-----------|--------------|
| Inspiring | Abrasive |
| Friendly | Overfamiliar |
| Helpful | Pushy |
| Confident | Cocky |
| Experts | Bores |
| Passionate | Overbearing |
...
- **Hold my beer mentality** — work hard, play harder
- **A-political** — point fun at whoever and whatever in a lighthearted way
- **Not afraid to offend, much** — there's a fine line but we understand our audience

### What Good Riot Writing Looks Like
- Shows revolutionary spirit
- Involves the reader
- Provokes an emotional response
- Demonstrates unique aspects of the brand
- Uses detail to paint a picture
- Makes promises and backs them up with evidence
...
- Vague corporate waffle

---

## Company Values
1. **Raise the bar** — deliver big ideas to a standard we've never seen before
2. **Embrace change** — be the fearless innovator, never happy with the status quo
3. **Keep learning** — engage in workshops, coaching, training; bring new skills into practice
4. **Own it** — take full control of projects, never shirk responsibility, never play the blame game
5. **Elevate others** — use your brilliance to make others brilliant
6. **Do more with less** — strive for ultimate efficiency with maximum impact
7. **Be weirdly fun** — deliver something unusual and exciting; we want to reign you in, not push you out
...
- E-liquids developed and produced through Fantasia Flavour House
- British manufacturing means jobs, quality control and supply chain traceability
- Position: British manufacturing should be championed, not undermined by cheap imports

### Harm Reduction
- Vaping is at least 95% less harmful than smoking (Public Health England)
- Over 4 million UK adults have used vapes to quit smoking
- Riot exists to help people quit smoking — "liberating people from the choking grasp of cigarettes"
- Position: Harm reduction policy must be grounded in science, not moral panic

### Flavour Protection
- Flavoured vapes are a critical quitting aid for adult smokers
- Restricting flavours pushes people back to cigarettes or black market products
- Riot's flavour scientists replicate molecular profiles with extraordinary accuracy
- Position: Age-gated access, not blanket flavour bans

### Retailer Support
- Independent retailers are the backbone of the UK vaping market
- Riot provides compliance training, POS materials, category management
- Direct retailer comms via WhatsApp channel ("No spam. Just honest retailer support.")
- Position: A well-informed retailer is the best gatekeeper against underage sales

### Vape Tax (Vaping Products Duty)
- **VPD starts:** 1 October 2026
- **Rate:** £2.20 per 10ml (flat rate, regardless of nicotine strength)
- **Duty stamps** required on all retail packaging from 1 October 2026
- **Full shelf compliance:** 1 April 2027 (unstamped products become illegal to sell)
- **Tobacco duty increase** alongside VPD to maintain price incentive to switch
- **Registration/approvals open:** 1 April 2026
- Riot's position: Tax must be proportionate and maintain a clear price gap vs cigarettes
- Riot is working to be fully tax-stamp ready ahead of deadline
- Comms approach: "What's confirmed > What it means > What to do now > How Riot helps"

### Compliance & Standards
- All Riot products are fully TRPR compliant and MHRA notified
- Riot voluntarily exceeds minimum regulatory requirements
- Position: The industry must self-regulate to the highest standard or lose the right to exist

### Chinese Disposables
- Non-compliant disposables are overwhelmingly imported, not UK-manufactured
- Many fail basic safety tests and contain nicotine above legal limits
- Position: Stronger border enforcement, stricter import controls, meaningful penalties
- Key framing: "The disposable crisis is an import problem, not a vaping problem"

### Riot Activist
- Campaigning arm mobilising vapers, retailers and industry partners
- Fights misinformation, disproportionate regulation and anti-vaping policies
- Notable campaigns: Welcome to Wroxham, Chief Misinformation Officer, Rishi's Vape Shop
- Position: Every vaper has a stake in the regulatory outcome and a right to be heard
...
### Previous PR Agency
- **Idea Farm** — managed PR on a £9k/month retainer
- Delivered 119 unique placements across 60 publications (Feb–Aug period)
- Campaigns included: Heat Map, Vaping on Zoom, Riot X, Countdown Vape Party, Chief Misinformation Officer, Ibiza Final Boss
- **Decision:** Moved to project-only (Option E) — no retainer, pay per project
- **Reason:** £108k+ VAT annualised cost, weak direct sales attribution, cashflow priority
- Riot PR Desk is being built to fill the gap left by reducing agency dependency

### Notable PR Campaigns
- **Welcome to Wroxham** — sponsored non-league football club, 3-part documentary, 300k+ social views, viral coverage
- **Chief Misinformation Officer** — activist campaign against junk science on vaping
- **Rishi's Vape Shop** — political activist stunt
- **Merry Quitmas** — Christmas campaign featuring East 17
- **Sausage Fingers** — viral social campaign

### Comms Channels
| Channel | Purpose | Tone |
|---------|---------|------|
| Trade media | Industry press (The Grocer, Talking Retail, Vape Business) | Corporate/Trade |
| National press | Newspapers, broadcast, general news | Corporate |
| WhatsApp retailer channel | Direct retailer updates | Informal, punchy, practical |
| Email | "Single source of truth" for retailers | Clear, structured |
| LinkedIn | Company page, industry thought leadership | Professional but engaging |
| Social media (Instagram, TikTok, X) | Consumer engagement, campaigns | Bold, creative, fun |
- Sales team and WhatsApp do the heavy lifting for trade comms
- Social stays high-level and confidence-building
- Lead with "what we're doing to help" not fear

### Vape Tax Comms Strategy
The comms plan follows a phased approach:
1. **Clarity first** (now) — calm the noise, simple timeline, position Riot as "safe pair of hands"
2. **Rule details** (March 2026) — translate complexity into 3 actions max
3. **Registration opens** (April 2026) — show how Riot is de-risking supply and compliance
4. **90-day countdown** (July 2026) — protect retailer cashflow, lock in range choices
5. **Final countdown** (Aug–Sept 2026) — make compliance idiot-proof
6. **Go-live** (October 2026) — smooth trading, zero confusion, win share
7. **Beyond** (Oct 2026–Apr 2027) — move market to 100% stamped shelves

Every update follows the format: **What's confirmed > What it means > What to do now > How Riot helps**
...
### UK Vaping Market
- Vaping is regulated under TRPR (Tobacco and Related Products Regulations) and MHRA notification
- Key regulators: MHRA, DHSC, parliamentary groups on vaping
- Major trade shows: Hall of Vape (Germany), InterTabac (Germany), Czech VaperEx Pro
- Key publications: The Grocer, Talking Retail, Asian Trader, RN Vape and Next Gen Retailer

### Industry Challenges
- Non-compliant Chinese disposables flooding the UK market
- Youth vaping concerns driving political pressure for tighter regulation
- Vape tax (VPD) introducing cost and compliance complexity from October 2026
- Misinformation about vaping health risks in mainstream media
- Potential flavour bans under discussion

### Riot's Competitive Position
- One of few UK-based manufacturers (most competitors import)
- Strong trade relationships with independent retailers
- Active campaigning/activist stance differentiates from competitors
- In-house flavour development (Fantasia Flavour House) and product design
- Multi-brand portfolio (Riot, KURO, white label via Fantasia)
...
> "We built Riot in the UK because we believe the best products come from people who actually give a damn about what they're making. Every bottle that comes out of our facility is something we stand behind. You can't say that about a container full of products shipped from the other side of the world with no audit trail."

**On harm reduction:**
> "Let's be honest — vaping isn't perfect. But it's a hell of a lot better than smoking. And four million adults in this country have used it to quit cigarettes. That's not a rounding error. That's real people with longer, healthier lives. Anyone who wants to ban it or tax it into the ground owes those four million people a proper explanation."

**On regulation:**
> "We don't fear regulation. We welcome it — when it's based on evidence and proportionate to the risk. What we won't accept is politicians using vaping as an easy target while ignoring the actual problem, which is cigarettes and non-compliant black market products."

**On the vape tax:**
> "Tax us fairly, maintain the price gap with cigarettes, and we'll get on with it. But if you price vapes out of reach of the people who need them most — working-class smokers trying to quit — you're not protecting public health. You're abandoning it."

**On Riot's mission:**
> "We're not just selling e-liquids. We're trying to end smoking. That sounds like a big thing to say, but it's genuinely what gets us up in the morning."

### David Donaghy — Head of Brand & Marketing (Strategic, commercially sharp)

**On Riot's comms approach:**
> "The vaping industry spent years being apologetic. We decided to stop apologising and start arguing. Not aggressively — persuasively. We have the science, the stories and the data. The only thing we've been missing is confidence."

**On news-jacking:**
> "PR isn't about waiting for someone to call you. It's about inserting yourself into the conversations that matter. Every major news cycle has a Riot angle if you're paying attention. The vape tax, the NHS, the cost of living — they all touch us. We just have to be fast and relevant."

**On the retailer relationship:**
> "Our retailers are often the last line of defence between a compliant product and a counterfeit one. We owe them clear information, fast answers and practical support. The WhatsApp channel isn't a marketing exercise — it's us being useful."

**On brand differentiation:**
> "There are hundreds of vape brands. Most of them look the same, say the same things and compete on price. We'd rather compete on conviction. People remember what you stand for. They forget what you charge."
...
Use these verified facts in all outputs. Never fabricate statistics.

### Harm Reduction
- Vaping is **at least 95% less harmful** than smoking — Public Health England / NHS
- **4 million+** UK adults currently vape (ONS/ASH data)
- **3.8 million** UK vapers use vaping to help them quit or stay off cigarettes
- Vaping is the **most popular quit-smoking tool** in the UK, used by more people than NRT patches or gum
- **Secondhand vape** emissions are not considered harmful to bystanders — contrary to cigarette smoke

### The Scale of Smoking
- **6.4 million** adults in the UK still smoke
- Smoking kills **75,000+ people** in the UK every year
- Smoking costs the NHS **£2.5 billion** per year
- Cigarettes remain the **leading preventable cause of death** in the UK

### Industry / Market
- UK vaping market worth approximately **£1.5–2 billion** annually
- Estimated **12,000+** independent vape retailers in the UK
- Disposable vapes represent over 50% of UK market volume
- Non-compliant products estimated to represent **30–40%** of disposable market

### Vape Tax (VPD) — Key Numbers
- **£2.20 per 10ml** — VPD rate from 1 October 2026
- **1 October 2026** — VPD starts; duty stamps required on all retail packaging
- **1 April 2027** — full shelf compliance (unstamped products illegal to sell)
- **1 April 2026** — registration/approval window opens
- Estimated **£100m+** additional revenue expected by HMRC from VPD
- The government has committed to a tobacco duty increase alongside VPD to maintain the switching price incentive

### Riot Labs
- Riot manufactures e-liquids through **Fantasia Flavour House** — in-house, UK-based
- Products sold through **12,000+** retailer touchpoints across the UK
- Welcomed **119 unique media placements** across 60 publications (Idea Farm, Feb–Aug period)
- Wroxham FC documentary: **300,000+** social views

---

## Forbidden Phrases (DO NOT USE)

These corporate clichés and vape-industry clichés must be avoided in all AI outputs. Flag them for human review if they appear.

### Corporate waffle to avoid
- "We are delighted to announce"
- "We are pleased to confirm"
- "We are excited to share"
- "World-class" / "best-in-class" / "industry-leading"
- "Going forward" / "moving forward"
- "Leveraging" / "utilising" / "synergies"
- "At this moment in time"
- "Due to the fact that" (use "because")
- "In order to" (use "to")
- "We believe that" (just say it)
- "Holistic approach"
- "Robust solutions"
- "Paradigm shift"
- "Stakeholders" (use "people" / "retailers" / "consumers")
- "Touch base"
- "Circle back"
- "Boil the ocean"
- "Low-hanging fruit"
- "Move the needle"
- "Take it offline"
- "Bandwidth" (in a non-technical context)

### Vaping industry clichés to avoid
- "The vaping revolution"
- "Journey" (unless literal)
- "Empowering smokers to make better choices" — too corporate
- "Responsible innovation" — overused
- "Community" — use sparingly and only where it's earned
- "Premium" — say what makes it good, not just that it's premium

### Tone traps
- **Don't be preachy** — Riot's voice is confident, not lecturing
- **Don't over-apologise** — Riot defends vaping from a position of strength
- **Don't over-qualify** — "This is not medical advice but..." undermines authority. Say what you know, flag genuine uncertainty factually
- **Don't use passive voice** when active is clearer: "The decision was made" → "We decided"
- **Don't use ALL CAPS for emphasis** — use bold or rewrite the sentence
...
### Welcome to Wroxham (Activist + Brand campaign)
**What:** Sponsored non-league football club Wroxham FC. Produced a 3-part documentary series.
**Why it worked:**
- Tangible, real-world action (not just words)
- Underdog story — mirrors Riot's own challenger brand narrative
- Long-form content justified by editorial value
- Built genuine community and brand warmth
- Generated 300k+ organic social views without paid media
**Lesson:** Find the human story first. The PR angle follows.

### Chief Misinformation Officer (Activist campaign)
**What:** Response to a wave of misleading anti-vaping stories in national media. Positioned Riot as the fact-checker.
**Why it worked:**
- Reactive and fast — struck while the news was hot
- Clear antagonist (junk science / irresponsible journalism)
- Gave Riot a hero role without self-promotion
- Got coverage in the same outlets that had run the misinformation
**Lesson:** Don't just counter-punch — make the counter-punch interesting.

### Rishi's Vape Shop (Activist stunt)
**What:** Political stunt timed to the budget/vape tax announcement.
**Why it worked:**
- Topical — piggybacked a news moment everyone was talking about
- Visual and shareable — worked as an image/video
- Comedic but made a serious point
- Low-cost, high-impact
**Lesson:** The best stunts make you laugh first, think second.

### Ibiza Final Boss (Brand / lifestyle)
**What:** Campaign linking Riot to Ibiza nightlife/music culture.
**Why it worked:**
- Spoke directly to the consumer audience (not just vapers — clubbers, nightlife crowd)
- Tied the brand to an aspirational lifestyle moment
- Different from every other vaping brand in the category
**Lesson:** The best vaping PR doesn't talk about vaping.

### Principles for Future Campaigns
1. **Speed beats perfection** — the window for news-jacking is 24–48 hours
2. **Pick a clear villain** — better policy, better science, better retailers vs non-compliant imports
3. **Have a visual** — if it can't be photographed or filmed, it barely happened in PR terms
4. **Make the media's job easy** — give them the story ready to run
5. **Involve real people** — retailers, vapers, employees make better stories than press releases alone
6. **Be the underdog** — Riot's strength is punching above its weight class. Own that.
...
> **About Riot Labs**
> Riot Labs is a British vaping company on a mission to help people quit smoking for good. Founded and headquartered in the UK, Riot manufactures its e-liquids through Fantasia Flavour House, its in-house flavour development operation. The company's portfolio includes Riot Bar Edtn, RIOT CONNEX and KURO. Through its Riot Activist campaigning arm, Riot fights misinformation and disproportionate regulation that would harm adult smokers' right to switch to less harmful alternatives. Riot is a member of the IBVTA and UKVIA. For more information visit riotlabs.com.

### Media contact (placeholder)
> Press enquiries: press@riotlabs.com

### Notes to editors (standard)
> - All Riot products are fully TRPR compliant and MHRA notified
